...
| [
    ...
    ["loose", (($loose | length) | tostring) + " of " + ($n | tostring) + " on their own",
      rate((($loose | length) * 100 / (if $n == 0 then 1 else $n end) | floor); 40; 70),
